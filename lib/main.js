...
var windowTrackerDelegate = {
	...
	onTrack: function (window) {
		...
		freeboxElement.setAttribute("label", "Envoyer sur le Freebox server" + (downloadLocation === null ? "" : " dans " + downloadLocation));
		// Create hbox element
		...
		window.dialog.onOK = function () {
			...
			if (freeboxElement.selected) {
				...
				if (downloadLocation !== null) {
					...
					LocationManager.add(downloadDomain, downloadPath);
